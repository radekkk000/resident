...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // trainer
        if ($pathinfo === '/trainer') {
            return array (  '_controller' => 'AppBundle\\Controller\\ResidentController::trainerAction',  '_route' => 'trainer',);
        }

        // app_resident_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'app_resident_homepage');
            }

            return array (  '_controller' => 'AppBundle\\Controller\\ResidentController::homepageAction',  '_route' => 'app_resident_homepage',);
        }
